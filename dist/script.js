...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector) {
    ...
    closeButtons && closeButtons.forEach(function (closeBtn) {
      // клик на элемент закрытия окна 
      closeBtn.addEventListener('click', function () {
        closeWindow(modalWindow); //        modalWindow.style.display = 'none';
        //        document.body.style.overflow = '';
    ...
    modalWindow.addEventListener('click', function (e) {
      if (e.target === modalWindow) {
        ...
        //document.body.style.overflow = '';
        closeWindow(modalWindow); //document.body.classList.remove('modal-open');
      }
    });
  } // test
  ...
  bindModal('.phone_link', '.popup', '.popup_dialog .popup_close'); //  bindModal('.contact_us','.popup','.popup_dialog .popup_close');
};
