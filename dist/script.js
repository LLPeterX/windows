...
/* harmony import */ var _modules_promoTimer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/promoTimer */ "./src/js/modules/promoTimer.js");
/* harmony import */ var _modules_works__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/works */ "./src/js/modules/works.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var timer = {
    timerId: null
  }; // таймер появления окна вызова обмерщика - объект, чтобы передать по ссылке

  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(timer);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); // табы внутри окна подсчета стоимости

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline'); // формы отправки данных

  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(modalState, timer); //promotionTimer('2020-08-01 00:00'); // не показывает вообще, т.к. дата прошла

  Object(_modules_promoTimer__WEBPACK_IMPORTED_MODULE_5__["default"])('2020-09-01 00:00');
  Object(_modules_works__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
/* harmony import */ var _checks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checks */ "./src/js/modules/checks.js");
...
var changeState = function changeState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      ...
      // All() - для forEach(), чтобы не заморачиваться с индивидуалами
  windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox');
  Object(_checks__WEBPACK_IMPORTED_MODULE_1__["checkInputAsNumber"])('#width');
  Object(_checks__WEBPACK_IMPORTED_MODULE_1__["checkInputAsNumber"])('#height'); // значения по умолчанию для отдельных полей/селекторов ввода
  ...
  var setDefaultValues = function setDefaultValues() {
    ...
    if (state.profile == undefined) {
      // профиль. по умолчанию 2-й, "теплое"
    ...
    elements.forEach(function (item, i) {
      item.addEventListener(event, function () {
        switch (item.nodeName) {
          case 'SPAN':
            // иконки формы балкона
            state[prop] = "\u0422\u0438\u043F".concat(i + 1);
            break;

          case 'INPUT':
            // либо профиль (холодное/теплое), либо размеры (width & height)
            if (item.getAttribute('type') === 'checkbox') {
              // профиль
              state[prop] = i === 0 ? 'Холодное' : 'Теплое'; // чтобы можно было вбрать только один чекбокс, сначала снимаем все метки,
...
/***/ "./src/js/modules/checks.js":
/*!**********************************!*\
  !*** ./src/js/modules/checks.js ***!
  \**********************************/
/*! exports provided: checkInputAsNumber, checkInputsNonZero */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkInputAsNumber", function() { return checkInputAsNumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkInputsNonZero", function() { return checkInputsNonZero; });
...
var checkInputAsNumber = function checkInputAsNumber(selector) {
...
var checkInputsNonZero = function checkInputsNonZero(inputs, btn) {
  if (inputs) {
...
/* harmony import */ var _checks__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./checks */ "./src/js/modules/checks.js");
...
var getParentWindow = function getParentWindow(el) {
...
var forms = function forms(state, timer) {
  var allForms = document.querySelectorAll('form'); // сообщения, выводимые в процессе отправки двнных формы на сервер
  ...
  Object(_checks__WEBPACK_IMPORTED_MODULE_11__["checkInputAsNumber"])('input[name="user_phone"]');
  allForms.forEach(function (form) {
    return form.addEventListener('submit', function (e) {
      e.preventDefault(); // create statusmessage block 

      var statusMessage = document.createElement("div");
      statusMessage.classList.add("status");
      form.appendChild(statusMessage); // функция отправки POST на сервер
      ...
      postData("http://food/server.php", data) //postData('assets/server.php',data)
      .then(function (res) {
        ...
        }, 5000); // после отправки (или при ошибке) закрываем ЛЮБУЮ форму, через 1 сек после сообщения
        // TODO: проверить, закрывается ли окно если кликнуть на подложку сразу после отправки

        var w = getParentWindow(form);
        setTimeout(function () {
          Object(_modals__WEBPACK_IMPORTED_MODULE_12__["closeWindow"])(w);
        }, 6000);
      });
    });
  });
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: closeWindow, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modals = function modals(timer) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var openButtons = document.querySelectorAll(triggerSelector),
        modalWindow = document.querySelector(modalSelector),
        closeBtn = document.querySelector(closeSelector),
        allWindows = document.querySelectorAll('[data-modal]'); // const closeWindow = (el) => {
  ...
  var showModalAfterTimeout = function showModalAfterTimeout(selector, timeout) {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); // окна расчета стоимости

  bindModal('.popup_calc_btn', '.popup_calc', '.popup_calc_close');
  bindModal('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', false);
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); //timer.timerId = showModalAfterTimeout('.popup', 60000); // убрал, чтобы не мешало.
};

var closeWindow = function closeWindow(selector) {
  if (!selector) {
    return;
  }
...
var promoTimer = function promoTimer(deadline) {
  function getRemainingTime(endtime) {
    var t = Date.parse(endtime) - new Date(); // разница в ms
  ...
  function setClock(selector, endtime) {
    ...
    var daysElement = timer.querySelector('#days'),
    ...
    function replacePromoText(selector, dateStr) {
      ...
      var _dateStr$split = dateStr.split(' '),
          ...
          ymd = _dateStr$split2[0],
          timeStr = _dateStr$split2[1];
      ...
      var newStr = day.substring(0, 2) + " " + months[+month - 1] + " " + year + " " + (timeStr || ""); //el.innerHTML = el.innerHTML.replace('Акция закончится 1 августа в 00:00', 'Акция закончится ' + newStr);

      el.textContent = "\u0423\u0441\u043F\u0435\u0439 \u0441\u044D\u043A\u043E\u043D\u043E\u043C\u0438\u0442\u044C \u043D\u0430 \u043E\u0441\u0442\u0435\u043A\u043B\u0435\u043D\u0438\u0438! \u0422\u043E\u043B\u044C\u043A\u043E \u0434\u043E ".concat(day, " ").concat(months[+month - 1], "!");
    }
...
/* harmony default export */ __webpack_exports__["default"] = (promoTimer);
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector) {
  var activeClass = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  var displayMode = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  ...
  var showContent = function showContent() {
    ...
    content[i].style.display = displayMode;
    tabs[i].classList.add(activeClass);
  };

  header.addEventListener('click', function (e) {
    var target = e.target; //debugger;

    if (target && (target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
      // remove "." in tabSelector
...
var OurWorks = function OurWorks() {
  // создаем модальное окно
  var popupWindow = document.createElement('div');
  var section = document.querySelector('.works');
  var bigImage = document.createElement('img'); // для отображения большой картиники создаем <div> с классом popup внутри section .works
  ...
  bigImage.style.border = "2px solid white"; // размеры окна
  ...
  section.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      ...
      var imgPath = target.parentNode.getAttribute("href"); // из внешнего тега <a>
