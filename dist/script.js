...
var calculator = function calculator() {
  ...
  var closeButton = document.querySelector('.popup_calc_close'); // слушатели на все возможные кнопки открытия окна
...
var forms = function forms() {
  ...
  allForms.forEach(function (form) {
    return form.addEventListener('submit', function (e) {
      ...
      var data = new FormData(form); //postData("http://food/server.php", data)

      postData('assets/server.php', data).then(function (res) {
        console.log(res);
